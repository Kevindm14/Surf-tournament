...
ActiveRecord::Schema.define(version: 2018_12_04_145048) do
  ...
  create_table "categories_participants", id: false, force: :cascade do |t|
    ...
    t.index ["category_id", "participant_id"], name: "index_categories_participants_on_category_id_and_participant_id"
  end
